...
export interface ContentRow {
  ...
  /** صورة مصغّرة حقيقية (poster) للفيديو، متولّدة ومرفوعة وقت الرفع نفسه
   *  — راجع src/lib/videoThumbnail.ts. اختيارية عشان لا تكسر أي بيانات
   *  قديمة (فيديوهات اترفعت قبل إضافة الميزة دي) أو DEMO_CONTENT. */
